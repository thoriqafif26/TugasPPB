package com.moh.thoriq_afif_19102153.praktikum11
...
import com.moh.thoriq_afif_19102153.praktikum11.data.Quote
import com.moh.thoriq_afif_19102153.praktikum11.databinding.ActivityQuoteAddUpdateBinding
import com.moh.thoriq_afif_19102153.praktikum11.helper.ALERT_DIALOG_CLOSE
import com.moh.thoriq_afif_19102153.praktikum11.helper.ALERT_DIALOG_DELETE
import com.moh.thoriq_afif_19102153.praktikum11.helper.EXTRA_POSITION
import com.moh.thoriq_afif_19102153.praktikum11.helper.EXTRA_QUOTE
import com.moh.thoriq_afif_19102153.praktikum11.helper.RESULT_ADD
import com.moh.thoriq_afif_19102153.praktikum11.helper.RESULT_DELETE
import com.moh.thoriq_afif_19102153.praktikum11.helper.RESULT_UPDATE
...
class QuoteAddUpdateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun getCategories(): ArrayList<String> {
        ...
        firestore.collection("categories")
            ...
            .addOnFailureListener { exception -> Toast.makeText(this@QuoteAddUpdateActivity, "Categories cannot be retrieved ", Toast.LENGTH_SHORT).show()
            }
